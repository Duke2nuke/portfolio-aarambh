      ...
      <div className="contact-container">
        ...
        <div className="contact-flex">
          <div className="contact-box">
            <h4>Email</h4>
            <p>
              <a href="mailto:Duke3nuke4109@gmail.com" data-cursor="disable">Duke3nuke4109@gmail.com</a>
            </p>
            <h4>Phone</h4>
            <p>
          ...
          <div className="contact-box">
            <h2>
              Designed and Developed <br /> by <span>Aarambh</span><br /> by <span>Aarambh</span>
            </h2>
            <h5>
